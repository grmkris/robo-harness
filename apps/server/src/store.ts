...
db.exec(`
 ...
 CREATE TABLE IF NOT EXISTS chat_images(id TEXT PRIMARY KEY,session_id TEXT NOT NULL REFERENCES conversations(id),frame_id TEXT NOT NULL,media_type TEXT NOT NULL,bytes BLOB NOT NULL);
